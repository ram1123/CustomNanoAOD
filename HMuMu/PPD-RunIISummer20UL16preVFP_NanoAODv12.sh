...
cat <<'EndOfTestFile' > PPD-RunIISummer20UL16preVFP_NanoAODv12_test.sh
#!/bin/bash
...
cmsDriver.py --python_filename PPD-RunIISummer20UL16preVFP_NanoAODv12_cfg.py \
...
# cmsRun PPD-RunIISummer20UL16preVFP_NanoAODv12_cfg.py

# End of PPD-RunIISummer20UL16preVFP_NanoAODv12_test.sh file
EndOfTestFile

chmod +x PPD-RunIISummer20UL16preVFP_NanoAODv12_test.sh
...
singularity run --no-home /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/PPD-RunIISummer20UL16preVFP_NanoAODv12_test.sh)
