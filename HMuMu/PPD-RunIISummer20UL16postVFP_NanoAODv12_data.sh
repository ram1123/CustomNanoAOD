...
cat <<'EndOfTestFile' > PPD-RunIISummer20UL16postVFP_NanoAODv12_test_data.sh
#!/bin/bash
...
chmod +x PPD-RunIISummer20UL16postVFP_NanoAODv12_test_data.sh
...
singularity run --no-home /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/PPD-RunIISummer20UL16postVFP_NanoAODv12_test_data.sh)
