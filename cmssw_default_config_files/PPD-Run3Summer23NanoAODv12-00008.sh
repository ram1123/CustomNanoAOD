...
# Dump actual test code to a PPD-Run3Summer23NanoAODv12-00008_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > PPD-Run3Summer23NanoAODv12-00008_test.sh
#!/bin/bash
...
# cmsDriver command
cmsDriver.py  --python_filename PPD-Run3Summer23NanoAODv12-00008_1_cfg.py --eventcontent NANOEDMAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --fileout file:PPD-Run3Summer23NanoAODv12-00008.root --conditions 130X_mcRun3_2023_realistic_v14 --step NANO --scenario pp --filein "dbs:/DYJetsToLL_M-50_TuneCP5_13p6TeV-madgraphMLM-pythia8/Run3Summer23MiniAODv4-PilotMuonHits_130X_mcRun3_2023_realistic_v14-v1/MINIAODSIM" --era Run3_2023 --no_exec --mc -n $EVENTS || exit $? ;

# End of PPD-Run3Summer23NanoAODv12-00008_test.sh file
EndOfTestFile

# Make file executable
chmod +x PPD-Run3Summer23NanoAODv12-00008_test.sh
...
singularity run --no-home /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/PPD-Run3Summer23NanoAODv12-00008_test.sh)
